...
def send_expiry_notification(
    ...
    body = (
        ...
        "  1. Run the command above locally with --print to extract updated cookies\n"
        "     from your browser and print their values.\n"
        "  2. Copy the values printed under each secret name.\n"
